...
export const EXTENSION_CONFIG_KEY = "SAS.ClinicalAcceleration";
 ...
 */
export const DEFAULT_COMPUTE_CONTEXT = "SAS Studio compute context";
...
export type Profile = ViyaProfile;
