...
- In the [Extension Development Host] instance of VSCode, select the SAS Clinical Acceleration icon from the Activity view.

## Adding a new locale

Follow these steps to add a new locale for the SAS Clinical Acceleration Extension for VSCode:
...
Follow these steps to update a locale for the SAS Clinical Acceleration Extension for VSCode:
